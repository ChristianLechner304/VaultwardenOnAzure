...
resource acaSubnet 'Microsoft.Network/virtualNetworks/subnets@2023-05-01' = if (enableVnetIntegrationWithAdditionalCosts) {
  name: '${vnet.name}/aca-infra'
  properties: {
...
resource storage 'Microsoft.Storage/storageAccounts@2023-01-01' = {
  ...
  dependsOn: enableVnetIntegrationWithAdditionalCosts ? [
    acaSubnet
  ] : []
}
...
resource managedEnv 'Microsoft.App/managedEnvironments@2023-05-01' = {
  ...
  location: location
  properties: {
    vnetConfiguration: enableVnetIntegrationWithAdditionalCosts ? {
      internal: false
